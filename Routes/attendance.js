...
const { validateAttendance, objectIdMiddleware, isLoggedIn, verifyTeacher, validateEditAttendance } = require('../middleware.js')
const attendance = require('../controllers/attendance')


router.route('/')
    .get(isLoggedIn, asyncError(verifyTeacher), objectIdMiddleware, asyncError(attendance.home))
    .post(isLoggedIn, asyncError(verifyTeacher), objectIdMiddleware, validateAttendance, asyncError(attendance.post))
...
router.route('/:dateId')
    ...
    .put(isLoggedIn, asyncError(verifyTeacher), objectIdMiddleware, validateEditAttendance, asyncError(attendance.put))
